...
const char *ssid = "M5Core2 GM Counter";
...
void Home() {
  ...
  webpage += "<tr><td>" + String(random(9, 9999)) + "</td>";
  webpage += "<td>" + String(random(9, 99) / 100.0f) + "</td>";
  webpage += "<td>" + String(random(9, 99) / 100.0f) + "</td>";
  webpage += "<td>" + String(random(9, 99) / 100.0f) + "</td>";
  webpage += "<td>" + String(random(9, 99) / 100.0f) + "</td></tr>";
  webpage += "</table> ";
  webpage += HTML_Footer();
}
//#############################################################################################
...
void Display_About() {
  ...
  webpage += "<table class='center'>";
  webpage += "<tr style = 'background-color:#606060;'><th>Parameter</th><th>Value</th></tr>";
  webpage += "<tr><td>LAN IP Address</td><td>" + String(ip[0]) + "." + String(ip[1]) + "." + String(ip[2]) + "." + String(ip[3]) + "</td></tr>";
