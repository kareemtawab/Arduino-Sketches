...
void emonget() {
  ...
  emon2.calcVI(50, 2000);        // Calculate all. No.of half wavelengths (crossings), time-out
  emon3.calcVI(50, 2000);        // Calculate all. No.of half wavelengths (crossings), time-out
